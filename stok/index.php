...
<html>
  <head>
    ...
    color:rgb(71, 73, 75); /* Warna teks (biru) */
    padding: 10px 20px; /* Padding untuk tombol */
    text-decoration: none; /* Menghilangkan garis bawah */
    transition: background-color 0.3s, color 0.3s; /* Transisi halus untuk efek hover */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Bayangan default */
}
...
.btn-transparent1:hover {
    background-color:rgba(255, 0, 0, 0.94); /* Warna latar belakang saat hover */
    color: white; /* Warna teks saat hover */
}
.btn-transparent.float-end:hover {
    background-color:rgb(21, 85, 223); /* Warna latar belakang saat hover */
    color: white; /* Warna teks saat hover */
}
      .card {
        height: 100%; 
