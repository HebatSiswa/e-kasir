...
<!-- NAVBAR START -->
  ...
  <div class="container">
    <h4 href="javascript:void(0);" onclick="window.history.back();">ALAMAK</h4>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php">Restock</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../user/index.php">User</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../produk/tambah.php">Tambah Produk</a>
        </li>
        <li class="nav-item">
