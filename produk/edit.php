...
<div class="container mt-5">
    <div class="row">
            ...
            <div class="col-8">
                ...
                <div class="mt-2">
                    <b class="form-label">Foto Produk : </b>
                ...
                <a href="hapus.php?id_produk=<?php echo $data['id_produk']?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin mengahpus produk <?php echo $data['nama_produk'] ?>?')">Hapus Produk</a>
                </div>
