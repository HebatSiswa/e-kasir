    ...
    <div class="row justify-content-center">
            <div class="col-9">
                ...
                <p class="fs-4"><b>Total harga keseluruhan : </b>
                    ...
                    <hr>
                <p class="text-primary fs-4 float-start" style="text-decoration:underline;"><b>Total bayar (awal) : </b>Rp. <?php echo number_format($data['bayar']) ?></p>
                ...
                <hr>
                            ...
                            <p><input type="text" name="bayar" placeholder="Masukan jumlah uang cash jika ingin diubah" class="form-control outline-primary" required></p> 
                            <div class="d-grid gap-2 mt-1">
                            <input type="submit" name="submit" class="btn btn-danger" value="Ubah Pembayaran">
