    ...
    <div class="col-md-12">
                    ...
                    <hr>
                        <form action="" method="POST">
                            ...
                            <input type="text" name="bayar" class="form-control" placeholder="Masukan jumlah uang Cash" required autofocus autocomplete="off">
...
if(isset($_POST['submit'])) {
    ...
    $update = mysqli_query($conn, "UPDATE transaksi SET total_kes='$total', bayar='$bayar', kembalian='$kembalian' WHERE id_transaksi = '$id_transaksi' ");
