...
.table tbody tr:nth-child(odd) {
        ...
        .table tbody tr:hover {
            background-color: #e6f7ff; /* Warna saat hover pada baris tabel */
        }
    </style>
</head>
  <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post">
                            ...
                            <input type="submit" name="lihat_transaksi" value="Tampilkan Transaksi" class="btn btn-sm">
                            <?php endif; ?>
                        </form>
